...
RECOVERY_NAME := ZenGarden

RECOVERY_RELEASE := 2.0.2.7-T

RECOVERY_VERSION := $(RECOVERY_NAME) $(RECOVERY_RELEASE)
...
ifneq ($(BOARD_UMS_LUNFILE),)
  LOCAL_CFLAGS += -BOARD_UMS_LUNFILE="$(TARGET_USE_CUSTOM_LUN_FILE_PATH)"
endif

ifneq ($(BOARD_HAS_KEY_DEBUG),)
  LOCAL_CFLAGS += -BOARD_HAS_KEY_DEBUG= true
endif

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_HAS_SMALL_RECOVERY BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_HAS_KEY_DEBUG
